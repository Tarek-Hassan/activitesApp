                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                <button onclick="window.location='{{ route('uploads.create') }}'"
                                ...
                                <th>Operation</th>
                                        ...
                                        @foreach($data as $value)
											...
											<tr>
												...
												<td>
                                                <a href="uploads/{{$value->id}}/edit"><button type="button" class="btn btn-primary" >Edite</button></a>
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					       ...
					       <form action="{{route('uploads.destroy',$value->id)}}" method="post">
					        <div class="modal-body">
					         {{method_field('delete')}}
					     	 {{csrf_field()}}
			          			<div>
			            			<div class="box-body">
			            			<p class="text-center">Are u sure want to delete this Post?</p>
