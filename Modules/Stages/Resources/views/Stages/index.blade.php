                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                <button onclick="window.location='{{ route('stages.create') }}'"
                                ...
                                <th>Operation</th>
                                        ...
                                        @foreach($data as $value)
											<tr>
												...
												<td>
                                                <a href="stages/{{$value->id}}/edit"><button type="button" class="btn btn-primary" >Edite</button></a>
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					       ...
					       <form action="{{route('stages.destroy',[$value->id])}}" method="post">
